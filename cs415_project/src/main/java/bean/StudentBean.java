...
public class StudentBean implements Serializable {
    ...
    public String getClassNameOfStudent(Student student){
        if (student instanceof PreUniStudent) {
            ClassModel classModel = ((PreUniStudent)student).getClassOfStudent();
            if (classModel != null) {
    ...
    public String getRoleNameOfStudent(Student student){
        if (student instanceof PreUniStudent) {
            Role role = ((PreUniStudent)student).getRole();
            if (role != null) {
